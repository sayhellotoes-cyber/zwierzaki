...
(function () {
  ...
  '<symbol id="ic-paw" viewBox="0 0 24 24"><circle cx="6.6" cy="9" r="2.5"/><circle cx="12" cy="6.7" r="2.7"/><circle cx="17.4" cy="9" r="2.5"/><path d="M12 10.9c-3.7 0-6.6 2.6-6.6 5.7 0 2.7 3 4.4 6.6 4.4s6.6-1.7 6.6-4.4c0-3.1-2.9-5.7-6.6-5.7z"/></symbol>' +
  ...
  // — szukaj —
  '<symbol id="ic-search" viewBox="0 0 24 24"><circle cx="11" cy="11" r="6.5"/><path d="M20 20l-4.3-4.3"/></symbol>' +
  // — konto / użytkownik —
  '<symbol id="ic-user" viewBox="0 0 24 24"><circle cx="12" cy="8.5" r="3.5"/><path d="M5.5 20c0-3.6 2.9-6.2 6.5-6.2s6.5 2.6 6.5 6.2"/></symbol>' +
  // — łóżko / nocleg —
  '<symbol id="ic-bed" viewBox="0 0 24 24"><path d="M3 8v10M3 12h18v6M21 18v-4.5a2.5 2.5 0 0 0-2.5-2.5H10v3"/><path d="M6.5 11.5a1.5 1.5 0 1 0 0-.01"/></symbol>' +
